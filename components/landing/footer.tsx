        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-xs">
                <li className="text-slate-500 flex items-center gap-1.5"><Icons.phone className="w-3.5 h-3.5 text-primary" /><a href="tel:+91 7011365481" className="hover:text-primary">+91 70113 65481</a></li>
